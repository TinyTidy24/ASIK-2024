...
export default function Card({image="./assets/Frame 609.png", name="ini product", price="000"}){
    ...
    return(<div className="flex flex-col gap-2.5">
        <div className="flex flex-col">
            ...
            <button className="bg-neutral-900 hover:bg-neutral-800 py-4 px-6 text-white flex justify-center items-center gap-1 rounded-b-lg">
                <img src="./assets/Cart1.png" alt="Keranjang"></img>
                Add to cart
            </button>
        </div>
        <div className="flex flex-col">
